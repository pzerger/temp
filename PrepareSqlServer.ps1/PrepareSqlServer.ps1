...
configuration PrepareAlwaysOnSqlServer
{
    ...
    Node localhost
    {
        ...
        xFirewall ScsmSdkPort
        {
            Direction = "Inbound"
            Name = "SCSM-SDK-TCP-In"
            DisplayName = "SCSM SDK Access (TCP-In)"
            Description = "Inbound rule for SCSM to allow SDK access."
            DisplayGroup = "System Center"
            State = "Enabled"
            Access = "Allow"
            Protocol = "TCP"
            LocalPort = "5724"
        ...
        xFirewall CiresonPortalInbound
        {
            Direction = "Inbound"
            Name = "Cireson-Portal-TCP-In"
            DisplayName = "Listening port for Cireson Portal (TCP-In)"
            Description = "Inbound rule to allow users to access the Cireson Portal."
            DisplayGroup = "SQL Server"
            State = "Enabled"
            Access = "Allow"
            Protocol = "TCP"
